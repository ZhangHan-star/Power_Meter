...
static void screen_event_handler (lv_event_t *e)
{
	...
	{
		ui_load_scr_animation(&guider_ui, &guider_ui.screen_1, guider_ui.screen_1_del, &guider_ui.screen_del, setup_scr_screen_1, LV_SCR_LOAD_ANIM_NONE, 200, 2000, false, true);
		break;
	}
	default:
		break;
