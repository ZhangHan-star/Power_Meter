...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->screen_cont_1, 160, 80);
	...
	lv_obj_set_style_border_color(ui->screen_cont_1, lv_color_hex(0xff0027), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_side(ui->screen_cont_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_cont_1, 50, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x00b6ff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_label_1, 30, 27);
	...
	lv_obj_set_style_bg_opa(ui->screen_label_1, 152, LV_PART_MAIN|LV_STATE_DEFAULT);
