...
void setup_scr_screen_waveW(lv_ui *ui)
{
    ...
    ui->screen_waveW_chart_1_0 = lv_chart_add_series(ui->screen_waveW_chart_1, lv_color_hex(0x00ff00), LV_CHART_AXIS_SECONDARY_Y);
    ...
    lv_obj_set_pos(ui->screen_waveW_label_power, 0, 61);
    lv_obj_set_size(ui->screen_waveW_label_power, 140, 20);
    ...
    lv_obj_set_style_pad_left(ui->screen_waveW_label_power, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
